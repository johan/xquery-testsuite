...
<xsl:stylesheet
   ...
   <xsl:template match="/">
      ...
      <html xmlns="http://www.w3.org/1999/xhtml">
         <head>
            <title>
               <xsl:text>XPath and XQuery Full Text 1.0 Test Suite Result Summary</xsl:text>
         ...
         <body>
            ...
            <blockquote>
               ...
               <p>
                  <xsl:text>The latest version of this test suite is XPath and XQuery Full Text 1.0 Test Suite </xsl:text>
               ...
               <p>The latest version of our files is available at
                  <a href="http://dev.w3.org/cvsweb/2007/xpath-full-text-10-test-suite/">http://dev.w3.org/cvsweb/2007/xpath-full-text-10-test-suite/</a>.
            ...
            <td valign="top">
               ...
               <xsl:if test='not(starts-with($test-name, "K-")) and not(starts-with($test-name, "K2-"))'>
                  <br>
                     ...
                     <font size="-2">
                        <xsl:text>&#xA0;&#xA0;&#xA0;&#xA0;(</xsl:text>
                        <a href='{concat("http://dev.w3.org/2007/xpath-full-text-10-test-suite/TestSuiteStagingArea/XQFTTSCatalog.xml#", $test-name)}'>catalog</a>
                        <xsl:text>, </xsl:text>
                        <a href='{concat("http://dev.w3.org/2007/xpath-full-text-10-test-suite/TestSuiteStagingArea/",$XQueryQueryOffsetPath, $FilePath, @name, $XQueryFileExtension)}'>query</a>
                        <xsl:text>)</xsl:text>
                     </font>
                  </br>
               </xsl:if>
